...
const Cuentos = () => {
    const { user, loading, publicar, cuentos, resolveCuento, noCuento, deleteCuento, editarCuento } = useApp()
                        ...
                        return (
                            <div className="d-flex justify-content-center" key={i}>
                                <div className="caja-autor">
                                    ...
                                    <button className="btn btn-dark" onClick={(e) => { e.preventDefault(); setUsuario(usuario) }}>Ver Los Cuentos</button>
                                </div> </div>
                        )
                    }
                    )}
